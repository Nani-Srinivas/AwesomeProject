...
export const OrderScreen = () => {
  ...
  const handleSaveProduct = (updatedProduct: any) => {
    ...
    Alert.alert('Success', `Product "${updatedProduct.name}" has been updated.`);
  };
      ...
      <View style={styles.content}>
        ...
        <View style={styles.productGrid}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => <ProductCard item={item} onEdit={handleEditPress} />}
...
const styles = StyleSheet.create({
  ...
  statusBorder: {
    ...
    marginRight: 16,
    backgroundColor: '#27ae60', // Default green color
  },
  cardContent: {
    flex: 1,
    flexDirection: 'row',
